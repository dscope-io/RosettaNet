module {
	...
	public type TaxSummaryTypeV02_04 = {
	...
	public type ShippedQuantityInformationTypeV02_25 = {
		DateTime : Int;
		schemaVersion : ?Text;
		BusinessDocumentReference : ?[BusinessDocumentReferenceTypeV01_12];
	...
	public type ProductSubLineItemTypeV02_04 = {
		...
		ShippedQuantityInformation : ?[ShippedQuantityInformationTypeV02_25];
	...
	public type SubstituteProductReferenceTypeV02_25 = {
		ProductIdentification : [ProductIdentificationTypeV01_04];
	...
	public type ProductLineItemTypeV02_04 = {
		...
		BuyerLineItem : Text;
		TaxSummary : ?TaxSummaryTypeV02_04;
		...
		ExpediteReferenceIdentifier : ?Text;
		SubstituteProductReference : ?[SubstituteProductReferenceTypeV02_25];

		MapReference : ?[MapReferenceTypeV02_25];

		ScheduledEvent : ?TransportationEventTypeV02_25;
		schemaVersion : ?Text;
		RequestedEvent : TransportationEventTypeV02_25;
		Identifier : ?[Text];
	...
	public type PurchaseOrderConfirmationTypeV02_04 = {
		schemaVersion : ?Text;
