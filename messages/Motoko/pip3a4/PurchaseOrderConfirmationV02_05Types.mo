module {
	...
	public type SpecialHandlingInstructionTypeV02_29 = {
		Text : ?Text;
		schemaVersion : ?Text;
	...
	public type AncillaryDocumentTypeV02_29 = {
		Name : Text;
		Version : Text;
		schemaVersion : ?Text;
	};

	public type PortalAccessTypeV02_29 = {
		Url : Text;
	...
	public type TaxSummaryTypeV02_05 = {
		TaxAmount : [TaxAmountTypeV01_06];
		TotalAmount : ?MonetaryAmountTypeV01_17;
		schemaVersion : ?Text;
	};

	public type ContractInformationTypeV02_29 = {
		Notes : ?Text;
		schemaVersion : ?Text;
		Identifier : Text;
	};
	...
	public type MilestoneDateTypeV02_29 = {
	...
	public type TaxExemptionTypeV02_29 = {
	...
	public type TaxExemptStatusTypeV02_29 = {
		IsTaxExempt : ?Bool;
		schemaVersion : ?Text;
		TaxExemption : ?TaxExemptionTypeV02_29;
	};
	...
	public type NetTermsTypeV02_29 = {
		Day : ?Int;
		Days : ?Int;
		schemaVersion : ?Text;
	};

	public type DiscountsTypeV02_29 = {
		Day : ?Int;
		Days : ?Int;
		Percent : ?Float;
		schemaVersion : ?Text;
	...
	public type PaymentTermsTypeV02_29 = {
		PaymentCondition : ?PaymentConditionTypeV01_03;
		schemaVersion : ?Text;
		NetTerms : NetTermsTypeV02_29;
		PercentDue : ?Float;
		Discounts : ?[DiscountsTypeV02_29];

	};

	public type FinancingTermsTypeV02_29 = {
		FinanceTerms : ?FinanceTermsTypeV01_03;
		PaymentTerms : ?[PaymentTermsTypeV02_29];
	...
	public type OrderQuantityTypeV02_29 = {
	...
	public type SpecialDiscountTypeV02_29 = {
	...
	public type MapReferenceTypeV02_29 = {
		PostOfficeBox : ?Text;
		Reference1 : Text;
		Reference2 : ?Text;
		PostalCode : ?Text;
	...
	public type ServiceLineItemTypeV02_05 = {
		ServiceIdentification : ?[Text];

		ServicePeriod : ?DatePeriodAndDurationTypeV01_17;
		AncillaryDocument : ?[AncillaryDocumentTypeV02_29];

		PortalAccess : ?[PortalAccessTypeV02_29];

		ContractInformation : ?ContractInformationTypeV02_29;
		ProductIdentification : ?ProductIdentificationTypeV01_04;
		MilestoneDate : ?[MilestoneDateTypeV02_29];
		...
		SpecialDiscount : ?[SpecialDiscountTypeV02_29];

		ProductOrderQuantity : ?OrderQuantityTypeV02_29;
		MapReference : ?[MapReferenceTypeV02_29];
	...
	public type ShippedQuantityInformationTypeV02_29 = {
		DateTime : Int;
		schemaVersion : ?Text;
		BusinessDocumentReference : ?[BusinessDocumentReferenceTypeV01_12];
	...
	public type CustomerInformationTypeV02_29 = {
		PartnerDescription : PartnerDescriptionTypeV01_16;
		schemaVersion : ?Text;
	...
	public type TransportationEventTypeV02_29 = {
		DateTimePeriod : ?DateTimePeriodTypeV01_03;
		TransportEvent : TransportEventTypeV01_03;
		schemaVersion : ?Text;
	};

	public type ProductSubLineItemTypeV02_05 = {
		OrderShippingInformation : ?OrderShippingInformationTypeV02_29;
		...
		ShippedQuantityInformation : ?[ShippedQuantityInformationTypeV02_29];

		IsDropShip : ?Bool;
		UnitPrice : ?MonetaryAmountTypeV01_17;
		OrderQuantity : OrderQuantityTypeV02_29;
		Information : ?Text;
		CustomerInformation : ?[CustomerInformationTypeV02_29];
	...
	public type SubstituteProductReferenceTypeV02_29 = {
		ProductIdentification : [ProductIdentificationTypeV01_04];
	...
	public type ProductLineItemTypeV02_05 = {
		OrderShippingInformation : ?OrderShippingInformationTypeV02_29;
		RequestedShipFrom : ?[LocationTypeV01_04];
		...
		BuyerLineItem : Text;
		TaxSummary : ?TaxSummaryTypeV02_05;
		ProductSubLineItem : ?[ProductSubLineItemTypeV02_05];
		...
		TaxExemptStatus : ?TaxExemptStatusTypeV02_29;
		PurchaseOrderFillPriority : ?PurchaseOrderFillPriorityTypeV01_03;
		PartnerDescription : ?[PartnerDescriptionTypeV01_16];
		...
		ExpediteReferenceIdentifier : ?Text;
		SubstituteProductReference : ?[SubstituteProductReferenceTypeV02_29];

		MapReference : ?[MapReferenceTypeV02_29];

		ScheduledEvent : ?TransportationEventTypeV02_29;
		schemaVersion : ?Text;
		RequestedEvent : TransportationEventTypeV02_29;
		Identifier : ?[Text];
	...
	public type ServiceLineItemByOptionTypeV02_05 = {
		ServiceIdentification : ?[Text];
	...
	public type OrderLineItemTypeV02_05 = {
		ServiceLineItem : ?ServiceLineItemTypeV02_05;
		ProductLineItem : ?ProductLineItemTypeV02_05;
		ServiceLineItemByOption : ?ServiceLineItemByOptionTypeV02_05;
		schemaVersion : ?Text;
	};

	public type SecondaryBuyerTypeV02_29 = {
		PartnerDescription : PartnerDescriptionTypeV01_16;
		schemaVersion : ?Text;
		Identifier : ?Text;
	};
	...
	public type CreditCardTypeV02_29 = {
		CardHolderName : Text;
		ExpiryDate : Int;
		CidIdentifier : ?Text;
		schemaVersion : ?Text;
	...
	public type AccountDescriptionTypeV02_29 = {
		AccountNumber : ?Text;
		CreditCard : ?CreditCardTypeV02_29;
	...
	public type PurchaseOrderTypeV02_05 = {
		OrderShippingInformation : ?OrderShippingInformationTypeV02_29;
		...
		TaxExemptStatus : ?TaxExemptStatusTypeV02_29;
		PurchaseOrderFillPriority : ?PurchaseOrderFillPriorityTypeV01_03;
		FinancingTerms : ?[FinancingTermsTypeV02_29];

		PartnerDescription : ?[PartnerDescriptionTypeV01_16];

		OrderLineItem : [OrderLineItemTypeV02_05];
		...
		SecondaryBuyer : ?SecondaryBuyerTypeV02_29;
		AccountDescription : ?AccountDescriptionTypeV02_29;
		PurchaseOrderStatus : PurchaseOrderStatusTypeV01_06;
	};
	...
	public type PurchaseOrderConfirmationTypeV02_05 = {
		schemaVersion : ?Text;
